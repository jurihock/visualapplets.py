...
This Source Code Form is subject to the terms of the Mozilla Public License 2.0. The file [LICENSE](https://github.com/jurihock/visualapplets.py/raw/main/LICENSE) contains a copy of the MPL. Alternatively obtain another one at [https://mozilla.org/MPL/2.0](https://mozilla.org/MPL/2.0).
